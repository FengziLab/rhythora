...
<div transition:fly={{ duration: 300, easing: circOut, x: screenTransitionX }} class="row-start-1 col-start-1 w-[75%] max-padh:w-[85%] max-padv:w-full max-w-600 h-full mx-auto p-16 flex flex-row flex-nowrap gap-8">
    ...
    <div class="w-full h-full rounded-xl bg-zinc-700/30 border-b-2 border-zinc-700/30 overflow-clip">
        <div class="w-full h-14 px-6 bg-zinc-700/30 border-b-2 border-zinc-700/30 flex flex-row flex-nowrap gap-2 items-center justify-start">
            ...
            <span class="text-zinc-50 text-lg font-comfortaa tracking-wide select-none">News</span>
        </div>
    </div>
    ...
    <div class="w-full flex flex-col flex-nowrap gap-8">
        ...
        <div class="w-full h-full rounded-xl bg-zinc-700/30 border-b-2 border-zinc-700/30 overflow-clip">
            <div class="w-full h-14 px-6 bg-zinc-700/30 border-b-2 border-zinc-700/30 flex flex-row flex-nowrap gap-2 items-center justify-start">
                ...
                <span class="text-zinc-50 text-lg font-comfortaa tracking-wide select-none">Event</span>
            </div>
        </div>
        ...
        <div class="w-full h-full rounded-xl bg-zinc-700/30 border-b-2 border-zinc-700/30 overflow-clip">
            <div class="w-full h-14 px-6 bg-zinc-700/30 border-b-2 border-zinc-700/30 flex flex-row flex-nowrap gap-2 items-center justify-start">
                ...
                <span class="text-zinc-50 text-lg font-comfortaa tracking-wide select-none">Changelog</span>
            </div>
        </div>

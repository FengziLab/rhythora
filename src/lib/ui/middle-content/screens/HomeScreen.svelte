...
<div transition:fly={{ duration: 300, easing: circOut, x: isToFromRight ? -100 : 100 }} class="row-start-1 col-start-1 w-[75%] max-padh:w-[85%] max-padv:w-full max-w-600 h-full mx-auto px-4 py-16 flex flex-row flex-nowrap gap-8">

    <!-- News content -->
    <div class="w-full h-full rounded-xl bg-zinc-700/30 border-b-2 border-zinc-700/30 overflow-clip">
        <div class="w-full h-14 px-6 bg-zinc-700/30 border-b-2 border-zinc-700/30 flex flex-row flex-nowrap gap-2 items-center justify-start">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="size-5 fill-zinc-50">
            ...
            <span class="text-zinc-50 text-lg font-comfortaa tracking-wide">News</span>
        </div>
    </div>
    ...
    <div class="w-full flex flex-col flex-nowrap gap-8">
        ...
        <div class="w-full h-full rounded-xl bg-zinc-700/30 border-b-2 border-zinc-700/30 overflow-clip">
            <div class="w-full h-14 px-6 bg-zinc-700/30 border-b-2 border-zinc-700/30 flex flex-row flex-nowrap gap-2 items-center justify-start">
                ...
                <span class="text-zinc-50 text-lg font-comfortaa tracking-wide">Event</span>
            </div>
        </div>
        ...
        <div class="w-full h-full rounded-xl bg-zinc-700/30 border-b-2 border-zinc-700/30 overflow-clip">
            <div class="w-full h-14 px-6 bg-zinc-700/30 border-b-2 border-zinc-700/30 flex flex-row flex-nowrap gap-2 items-center justify-start">
                ...
                <span class="text-zinc-50 text-lg font-comfortaa tracking-wide">Changelog</span>
            </div>
        </div>

...
<div class="w-full p-2 h-16 rounded-b-xl bg-zinc-700/30 {!(global.screen === "home" || global.screen === "song-select") ? "-translate-y-full" : ""} transition duration-300 ease-circ-out flex flex-row flex-nowrap gap-2 items-center justify-between">
    ...
    <div class="h-full flex flex-row flex-nowrap gap-2 justify-start">
        <!-- Settings button -->
        <button title="Settings" aria-label="Settings" class="w-12 h-full rounded-lg hover:bg-zinc-500/50 active:translate-y-0.5 transition duration-100 ease-[ease] flex items-center justify-center">
        ...
        <!-- Credits button -->
        <button title="Credits" aria-label="Credits" class="w-12 h-full rounded-lg hover:bg-zinc-500/50 active:translate-y-0.5 transition duration-100 ease-[ease] flex items-center justify-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 stroke-zinc-100">
